    ...
    <div className="diet-health-detail-page">
      <div className="mb-6">
        <Link to="/" className="text-white hover:text-gray-300 flex items-center">
          <i className="fas fa-arrow-left mr-2"></i> 返回健康仪表板
        </Link>
      </div>
      ...
      <div className="diet-health-detail-grid gap-4">
        ...
        <div className="diet-health-detail-card md:col-span-4 p-8 flex flex-col justify-center">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-6 text-white/90">
              <p className="text-lg">本页面基于您的年龄阶段和个人需求，提供详细的饮食推荐、营养成分分析以及健康饮食的科学依据，帮助您实现营养均衡、预防疾病、改善健康的目标。</p>
            </div>
          </div>
        </div>
          ...
          <div className="relative flex-grow flex flex-col z-10">
            ...
            <div className="space-y-4 flex-grow">
              <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                <h3 className="font-semibold text-white mb-2">膳食纤维 - 控糖控脂的关键</h3>
                <p className="text-white/90 text-sm">足量的膳食纤维（每日25-30g）可降低血液中胆固醇含量，促进肠道毒素排出，减少结直肠癌的发病风险。富含膳食纤维的食物包括全谷物、蔬菜、水果等，能增强饱腹感，稳定血糖水平。</p>
              </div>
              <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                <h3 className="font-semibold text-white mb-2">Omega-3脂肪酸 - 护心脑营养素</h3>
                <p className="text-white/90 text-sm">Omega-3脂肪酸（深海鱼、核桃）是构成大脑神经细胞膜的重要成分，能改善记忆力、缓解抑郁情绪，同时调节血脂，促进大脑发育，维持细胞膜功能。</p>
              </div>
              <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                <h3 className="font-semibold text-white mb-2">抗氧化物质 - 延缓衰老的秘密</h3>
                <p className="text-white/90 text-sm">富含抗氧化物质的食材（如蓝莓、西兰花、坚果）能清除体内自由基，延缓细胞氧化损伤，降低癌症、老年痴呆的发病概率。多食此类食物有助于提升免疫力。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="diet-health-detail-card md:col-span-2 p-8 flex flex-col">
          ...
          <div className="relative flex-grow flex flex-col z-10">
            ...
            <div className="space-y-4 flex-grow">
              <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                <h3 className="font-semibold text-white mb-2">控糖目标</h3>
                <p className="text-white/90 text-sm">用魔芋、山药替代精制主食；水果选柚子、草莓（低GI）；避免添加糖，少食多餐稳定血糖。推荐食物：燕麦、糙米、西兰花、菠菜、柚子、草莓。</p>
              </div>
              <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                <h3 className="font-semibold text-white mb-2">增肌目标</h3>
                <p className="text-white/90 text-sm">增加蛋白质摄入至平时的1.2-2倍，推荐鸡胸肉、三文鱼、鸡蛋、牛奶、豆腐等优质蛋白；搭配适量碳水化合物如藜麦、红薯，为肌肉合成提供能量。</p>
              </div>
              <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                <h3 className="font-semibold text-white mb-2">减脂目标</h3>
                <p className="text-white/90 text-sm">主食减半（选全谷物），蛋白质增加20%；蔬菜增至600g；控制总热量缺口300-500大卡。推荐食物：鸡胸肉、西兰花、黄瓜、苹果、杏仁。</p>
              </div>
              <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                <h3 className="font-semibold text-white mb-2">养胃目标</h3>
                <p className="text-white/90 text-sm">选择易消化食物如小米粥、蒸蛋、软烂蔬菜；避免刺激性食物如辣椒、咖啡；定时定量，细嚼慢咽。推荐食物：小米、山药、南瓜、胡萝卜、香蕉。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="diet-health-detail-card md:col-span-4 p-8 flex flex-col">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6 text-white/90">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">合理饮食对健康的核心影响机制</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                    <h4 className="font-semibold text-white mb-2">1. 预防慢性疾病：从根源降低发病风险</h4>
                    <p className="text-white/80 text-sm">慢性疾病（高血压、糖尿病、高血脂、心血管疾病、部分癌症）的诱因中，饮食因素占比高达60%以上。高钠饮食会升高血压，增加肾脏和心血管负担；长期高精制碳水饮食会导致胰岛素抵抗，诱发2型糖尿病；足量的膳食纤维（每日25-30g）可降低血液中胆固醇含量，促进肠道毒素排出，减少结直肠癌的发病风险。</p>
                  </div>
                  <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                    <h4 className="font-semibold text-white mb-2">2. 调节免疫功能：构建人体"防御屏障"</h4>
                    <p className="text-white/80 text-sm">免疫系统的正常运转依赖充足且均衡的营养供给：蛋白质是免疫细胞（白细胞、淋巴细胞）的主要构成原料，缺乏会导致免疫细胞数量减少、活性下降；维生素C促进抗体合成，维生素A维持呼吸道黏膜完整性，锌元素调节免疫细胞的分化与增殖。</p>
                  </div>
                  <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                    <h4 className="font-semibold text-white mb-2">3. 改善心理状态：饮食影响情绪与认知</h4>
                    <p className="text-white/80 text-sm">饮食与大脑神经递质的合成密切相关，进而影响情绪和认知能力：色氨酸（存在于鸡蛋、牛奶、豆制品中）是合成血清素（"快乐激素"）的前体，缺乏会导致情绪低落、焦虑；Omega-3脂肪酸（深海鱼、核桃）是构成大脑神经细胞膜的重要成分，能改善记忆力、缓解抑郁情绪。</p>
                  </div>
                  <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                    <h4 className="font-semibold text-white mb-2">4. 维持体重与体态：避免代谢综合征</h4>
                    <p className="text-white/80 text-sm">合理饮食通过"控制热量缺口 + 优化营养结构"，实现健康体重的维持，而非单纯的"节食减重"。全谷物、优质蛋白、膳食纤维能增强饱腹感，减少总热量摄入；健康脂肪（牛油果、橄榄油）能延缓胃排空速度，避免暴饮暴食。</p>
                  </div>
                </div>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">不同人群的饮食健康侧重点</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                    <h4 className="font-semibold text-white">久坐上班族</h4>
                    <p className="text-white/80 text-sm">需控制精制碳水、高油高盐外卖的摄入，增加膳食纤维和优质蛋白，预防"办公族三高"（高血脂、高血糖、高血压）</p>
                  </div>
                  <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                    <h4 className="font-semibold text-white">中老年人群</h4>
                    <p className="text-white/80 text-sm">侧重补钙（预防骨质疏松）、补优质蛋白（延缓肌肉流失）、控盐控糖（保护心血管和肾脏）</p>
                  </div>
                  <div className="bg-white/20 p-4 rounded-lg border border-white/30 backdrop-blur-sm">
                    <h4 className="font-semibold text-white">运动人群</h4>
                    <p className="text-white/80 text-sm">需在运动前后合理补充碳水（供能）和蛋白质（修复肌肉），避免过度节食或过量进补</p>
                  </div>
                </div>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">总结：合理饮食是健康的"底层逻辑"</h3>
                <p>合理饮食的本质是<strong className="text-white">"顺应人体生理规律"</strong>，通过食材的选择、营养的搭配、节律的把控，实现"养身"与"养心"的双重目标。它不是短期的"减脂方案"或"治病偏方"，而是贯穿一生的健康生活方式——与运动、作息、心态共同构成人体健康的四大支柱，缺一不可。</p>
              </div>
            </div>
          </div>
        </div>
