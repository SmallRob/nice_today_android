      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-6 text-white shadow-xl transform transition-all duration-300 hover:scale-102 active:scale-98 mobile-card" style={{ touchAction: 'manipulation' }}>
          <div className="text-center mb-4">
            ...
            <div className="text-4xl sm:text-5xl font-bold mb-2 drop-shadow-md">{overallScore}<span className="text-lg sm:text-xl opacity-75">分</span></div>
            <p className="text-blue-100 text-sm font-medium mobile-text mobile-responsive-text">{overallScore > 75 ? '运势极佳' : overallScore > 60 ? '运势良好' : overallScore > 45 ? '运势平稳' : '运势一般'}</p>
          </div>
          ...
          <div className="mt-4 flex justify-center items-center text-sm bg-white bg-opacity-10 rounded-full px-4 py-2 backdrop-blur-sm mobile-animation">
            <span className="mr-2 font-medium mobile-text mobile-responsive-text">运势最强:</span>
        ...
        {/* 今日运势描述 - 优化版 */}
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 shadow-lg border-l-4 border-blue-500 transition-all duration-200 hover:shadow-xl active:scale-98" style={{ touchAction: 'manipulation' }}>
        ...
        <div className="bg-gradient-to-r from-pink-50 to-red-50 dark:from-pink-900/20 dark:to-red-900/20 rounded-xl p-4 shadow border border-pink-100 dark:border-pink-800 transition-all duration-200 hover:shadow-md active:scale-98" style={{ touchAction: 'manipulation' }}>
          <h4 className="font-bold text-pink-700 dark:text-pink-300 mb-2 flex items-center mobile-responsive-heading">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-xl p-4 sm:p-5 shadow-lg border-l-4 border-green-500 transform transition-all duration-200 hover:scale-102 active:scale-98" style={{ touchAction: 'manipulation' }}>
            <h4 className="font-bold text-green-700 dark:text-green-300 mb-3 flex items-center text-lg mobile-responsive-heading">
              <span className="mr-2 text-lg">✅</span>
              宜做
            </h4>
          ...
          <div className="bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 rounded-xl p-4 sm:p-5 shadow-lg border-l-4 border-red-500 transform transition-all duration-200 hover:scale-102 active:scale-98" style={{ touchAction: 'manipulation' }}>
            <h4 className="font-bold text-red-700 dark:text-red-300 mb-3 flex items-center text-lg mobile-responsive-heading">
              <span className="mr-2 text-lg">❌</span>
              忌做
            </h4>
        ...
        {recommendations.soulQuestion && typeof recommendations.soulQuestion === 'object' && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-4 shadow border border-blue-100 dark:border-blue-800">
            <h4 className="font-bold text-blue-700 dark:text-blue-300 mb-2 flex items-center mobile-responsive-heading">
              <span className="mr-2">❓</span>问 {String(recommendations.soulQuestion.question || '今日问题')}
            </h4>
            <p className="text-blue-600 dark:text-blue-400 text-sm mobile-text mobile-responsive-text">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
            ...
            <div className="text-center">
              <div className="flex justify-center mb-2">
                <div 
                  className="w-10 h-10 rounded-full border-2 border-white shadow-md transition-transform duration-200 hover:scale-110 active:scale-95"
            ...
            {/* 幸运配饰 */}
            <div className="text-center">
              <div className="text-2xl mb-1 transition-transform duration-200 hover:scale-110 active:scale-95" style={{ touchAction: 'manipulation' }}>💎</div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/30 dark:to-indigo-900/30 rounded-xl p-4 shadow-lg border-l-4 border-purple-500 transition-all duration-200 hover:shadow-xl active:scale-98" style={{ touchAction: 'manipulation' }}>
          <div className="flex items-center">
            <span className="text-4xl mr-4 bg-white rounded-full p-2 shadow-md transition-transform duration-200 hover:scale-110 active:scale-95" style={{ touchAction: 'manipulation' }}>{horoscopeGuidance.horoscopeInfo.icon}</span>
            <div>
              <h4 className="font-bold text-purple-700 dark:text-purple-300 text-lg mobile-responsive-heading">
                {userHoroscope}
              </h4>
              <p className="text-purple-600 dark:text-purple-400 text-sm mobile-text mobile-responsive-text">
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 rounded-xl p-4 shadow border border-indigo-100 dark:border-indigo-800 mobile-card transition-all duration-200 hover:shadow-md active:scale-98" style={{ touchAction: 'manipulation' }}>
          <div className="flex items-center">
            <span className="text-2xl mr-3 transition-transform duration-200 hover:scale-110 active:scale-95" style={{ touchAction: 'manipulation' }}>🌙</span>
            <div>
  ...
  const renderMobileHoroscopeSelector = () => {
    return (
      <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 pb-3 pt-1 shadow-md">
        <div className="mb-3">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 mobile-text mobile-responsive-text">
            选择星座查看运势
          </label>
          {/* 使用网格布局替代横向滚动 */}
          <div className="grid grid-cols-4 sm:grid-cols-6 gap-1.5 px-1">
            {getHoroscopeData() && Array.isArray(getHoroscopeData()) ? getHoroscopeData().map((horoscope) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xl mb-0.5">{horoscope.icon}</span>
          ...
          <div className="mb-3 p-3 bg-yellow-50 dark:bg-yellow-900/30 rounded-xl border border-yellow-200 dark:border-yellow-700 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <span className="text-yellow-700 dark:text-yellow-300 text-sm mobile-text mobile-responsive-text">
                  临时查看 {userHoroscope} 的运势
                </span>
              </div>
              <button
                onClick={handleRestoreUserHoroscope}
                className="px-3 py-1.5 bg-blue-100 dark:bg-blue-800 text-blue-700 dark:text-blue-300 text-sm rounded-lg hover:bg-blue-200 dark:hover:bg-blue-700 transition-colors active:scale-95 mobile-button mobile-responsive-text"
                style={{ touchAction: 'manipulation' }}
              >
                恢复我的星座
              </button>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20 animate-fade-in performance-optimized safe-area-inset-top">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white p-4 shadow-lg">
        <h1 className="text-2xl font-bold flex items-center mobile-responsive-heading">
          <span className="mr-3 text-3xl">🔮</span>
          星座运势
        </h1>
        <p className="text-blue-100 text-sm mt-2 mobile-text">为您提供每日星座运势指导</p>
      </div>
      ...
      <div className="px-3 sm:px-4">
        ...
        {!loading && !error && horoscopeGuidance && userHoroscope ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2 mobile-responsive-heading">
              请选择您的星座
            </h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm mobile-text">
              点击上方星座按钮，查看您的每日运势
            </p>
          </div>
        ) : null}
