...
const TabContentLoader = memo(() => (
  <div className="flex justify-center items-center py-12">
    <div className="animate-spin rounded-full h-10 w-10 border-3 border-amber-300 border-t-amber-600 dark:border-amber-600 dark:border-t-amber-400"></div>
    <span className="ml-3 text-amber-900 dark:text-amber-200 font-medium">正在加载...</span>
  </div>
));
...
const MayaPage = memo(() => {
  ...
  return (
    <div className="maya-scroll-container bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700">
      {/* 玛雅历法顶部标题区域 - 固定定位 */}
      ...
      <div
        ref={containerRef}
        className={`maya-scroll-content container mx-auto px-4 py-4 max-w-4xl ${isMobile ? 'maya-scroll-optimized maya-scroll-stable' : ''
          }`}
      >
        {activeTab === 'calendar' && (
          <div>
